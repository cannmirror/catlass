...
private:
    virtual void BuildArgs(void *argsPtr, void *configPtr) override
    {
        ...
        printf("isThisKernelPaddingA_=%d\n", (int)isThisKernelPaddingA_);
        printf("isThisKernelPaddingB_=%d\n", (int)isThisKernelPaddingB_);
        printf("isNeedPaddingA_=%d\n", (int)isNeedPaddingA_);
        printf("isNeedPaddingB_=%d\n", (int)isNeedPaddingB_);
    }
