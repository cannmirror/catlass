...
#include "mixkernels/mla_preprocess/tiling/mla_preprocess_tilingdata.h"
...
constexpr uint32_t OFFSET_WORKSPACE = 4;  // the offset of workspace is 4
...
public:
    ...
    __aicore__ inline void RopeInit(GM_ADDR qGm, AscendC::GlobalTensor<CosDtype> &cosGm,
                                    ...
                                    AtbOps::MlaTilingData &ropeConcatParams)
    {
...
public:
    ...
    __aicore__ __force_inline__ void Init(GM_ADDR einSumOutGm, GM_ADDR scaleGm, GM_ADDR quantOutGm,
                                          const AtbOps::MlaTilingData &tilingData)
    {
    ...
    __aicore__ __force_inline__ void Process()
    {
        ...
        for (uint32_t batchIdx = 0; batchIdx < batchNum; batchIdx++) {
            ...
            for (uint32_t ubLoopIdx = 0; ubLoopIdx < ubHeadLoop; ubLoopIdx++) {
                ...
                AscendC::Cast(inputFp32_[calcTmpOffset], inputTensor_[calcTmpOffset],
                              AscendC::RoundMode::CAST_NONE, calcLength);
                AscendC::PipeBarrier<PIPE_V>();
                SET_FLAG(V, MTE2, pingFlag);
                // quant calc
                for (uint32_t colIdx = 0; colIdx < colLoop; colIdx++) {
                    colOffset = colIdx * CONST_64;
                    AscendC::Mul(inputFp32_[calcTmpOffset + colOffset],
                                 inputFp32_[calcTmpOffset + colOffset],
                                 scaleBrcbFp32_[scaleBrcbOffset],
                                 CONST_64, headPerLoop,
                                 {1, 1, 0, calcRepeatStride, calcRepeatStride, 1});
                }
                AscendC::PipeBarrier<PIPE_V>();
                // quant fp32 --> fp16 --> int8
                CastFrom32To16(inputFp32_[calcTmpOffset].template ReinterpretCast<half>(),
                               inputFp32_[calcTmpOffset], calcLength);
                AscendC::PipeBarrier<PIPE_V>();
                WAIT_FLAG(MTE3, V, pingFlag); // wait last result copy out
                CastFromF16ToI8(int8OutTensor_[calcTmpOffset],
                                inputFp32_[calcTmpOffset].template ReinterpretCast<half>(),
                                quantMin_, calcLength);
                AscendC::PipeBarrier<PIPE_V>();
            ...
            if (headTail > 0) {
                ...
                WAIT_FLAG(MTE2, V, pingFlag);
                AscendC::Cast(inputFp32_[calcTmpOffset], inputTensor_[calcTmpOffset],
                              AscendC::RoundMode::CAST_NONE, headTail * colNum);
                AscendC::PipeBarrier<PIPE_V>();
                SET_FLAG(V, MTE2, pingFlag);
                // quant calc
                for (uint32_t colIdx = 0; colIdx < colLoop; colIdx++) {
                ...
                // quant fp32 --> fp16 --> int8
                CastFrom32To16(inputFp32_[calcTmpOffset].template ReinterpretCast<half>(),
                               inputFp32_[calcTmpOffset], headTail * colNum);
                AscendC::PipeBarrier<PIPE_V>();
                WAIT_FLAG(MTE3, V, pingFlag); // wait last result copy out
                CastFromF16ToI8(int8OutTensor_[calcTmpOffset],
                                inputFp32_[calcTmpOffset].template ReinterpretCast<half>(),
                                quantMin_, headTail * colNum);
                AscendC::PipeBarrier<PIPE_V>();
                SET_FLAG(V, MTE3, pingFlag);
                WAIT_FLAG(V, MTE3, pingFlag);
                // int8 CopyOut
...
public:
    ...
    __aicore__ __force_inline__ void Init(GM_ADDR gmA, GM_ADDR gmB, GM_ADDR gmC, const AtbOps::MlaTilingData &mlaParams)
    {
#ifdef __DAV_C220_CUBE__
...
public:
    ...
    Init(GM_ADDR gmA, GM_ADDR gmB, GM_ADDR gmC, AtbOps::PpMatmulTilingData &tilingdata, uint32_t mode)
    {
        gm_a.SetGlobalBuffer(reinterpret_cast<__gm__ InDtype *>(gmA));
        gm_b.SetGlobalBuffer(reinterpret_cast<__gm__ InDtype *>(gmB));
        gm_c.SetGlobalBuffer(reinterpret_cast<__gm__ OutDtype *>(gmC));
...
public:
    ...
    __aicore__ __force_inline__ void Init(GM_ADDR gmInput, GM_ADDR gmOutput, GM_ADDR gmDescale, GM_ADDR gmPerTensorBias,
                                          GM_ADDR gmPertokenDescale, const AtbOps::PpMatmulTilingData &gmTilingData)
    {
...
__aicore__ __force_inline__ void PpMatmulW8a8Aiv<OutDtype, withSyncAll, quantMode>::Process()
{
    ...
    for (uint32_t loop_idx = core_idx; loop_idx < core_loop; loop_idx += core_num) {
        ...
        if constexpr (quantMode == QuantMode::PER_TENSOR_ASYMM_QUANT) {
            ...
            if (aligned_s32) {
                gm_to_ub<ArchType::ASCEND_V220, float>(ubPerTensorScale_,
                                                       gmPerTensorScale_[offsetScale],
                                                       0,                           // sid
                                                       1,                           // nBurst
                ...
                gm_to_ub_align<ArchType::ASCEND_V220, float>(ubPerTensorScale_,
                                                             gmPerTensorScale_[offsetScale],
                                                             0,                        // sid
                                                             1,                        // nBurst
                                                             n_actual * sizeof(float), // lenBurst
        ...
        if constexpr (quantMode == QuantMode::PER_TENSOR_ASYMM_QUANT) {
            ...
            WAIT_FLAG(V, MTE2, EVENT_ID0);
            if (aligned_s32) {
                gm_to_ub<ArchType::ASCEND_V220, ScaleDtype>(ubPerTensorScale_,
                                                            gmPerTensorScale_[offsetScale],
                                                            0,                                            // sid
                                                            1,                                            // nBurst
                ...
                gm_to_ub_align<ArchType::ASCEND_V220, ScaleDtype>(ubPerTensorScale_,
                                                                  gmPerTensorScale_[offsetScale],
                                                                  0,                             // sid
                                                                  1,                             // nBurst
        ...
        for (uint32_t i = 0; i < m_actual_per_vec; ++i) {
            mul_v<ArchType::ASCEND_V220, float>(ubTempFp32_[i * n_round], ubInput_.ReinterpretCast<float>()[i * n_round],
...
public:
    ...
    beta2GmTensor.SetGlobalBuffer(reinterpret_cast<__gm__ InDtype *>(beta2Gm));
        ...
        rmsNormQuant1.Init(gamma1GmTensor, beta1GmTensor, quantScale1GmTensor, quantOffset1GmTensor,
                           ...
                           num_col_1, 0.0001395089285, vectorBlockIdx * static_cast<uint64_t>(row_work) * num_col_1,
...
private:
    ...
    uint32_t perTaskNum;
    uint32_t resTaskNum;
    AtbOps::MlaTilingData mlaParams;
...
extern "C" __global__ __aicore__ void MLA_preprocess_attention_bf16(
    GM_ADDR sync, GM_ADDR hiddenStateGm, GM_ADDR gamma1Gm, GM_ADDR beta1Gm, GM_ADDR quantScale1Gm,
    GM_ADDR quantOffset1Gm, GM_ADDR wdqkvGm, GM_ADDR bias1Gm, GM_ADDR gamma2Gm, GM_ADDR beta2Gm, GM_ADDR quantScale2Gm,
    GM_ADDR quantOffset2Gm, GM_ADDR gamma3Gm, GM_ADDR sin1Gm, GM_ADDR cos1Gm, GM_ADDR sin2Gm, GM_ADDR cos2Gm,
    GM_ADDR keycacheGm, GM_ADDR slotMappingGm, GM_ADDR wuqGm, GM_ADDR bias2Gm, GM_ADDR wukGm, GM_ADDR descale1Gm,
    GM_ADDR descale2Gm, GM_ADDR gmCtkvScale, GM_ADDR gmQnopeScale, GM_ADDR qGm, GM_ADDR keycacheOutGm, GM_ADDR qGm2,
    GM_ADDR keycacheOutGm2, GM_ADDR s1Gm, GM_ADDR s2Gm, GM_ADDR s3Gm, GM_ADDR s4Gm, GM_ADDR s5Gm, GM_ADDR tilingGm)
{
    PRELOAD(2);
    ...
    SetNdpara(1, 0, 0);
#endif
    AtbOps::MlaTilingData mlaTilingData;
    auto gmMlaTilingData = reinterpret_cast<__gm__ AtbOps::MlaTilingData *>(tilingGm);
    mlaTilingData.n = gmMlaTilingData->n;

    mlaTilingData.mm1.numBatch = gmMlaTilingData->mm1.numBatch;
    mlaTilingData.mm1.m = gmMlaTilingData->mm1.m;
    mlaTilingData.mm1.k = gmMlaTilingData->mm1.k;
    mlaTilingData.mm1.n = gmMlaTilingData->mm1.n;
    mlaTilingData.mm1.m0 = gmMlaTilingData->mm1.m0;
    mlaTilingData.mm1.k0 = gmMlaTilingData->mm1.k0;
    mlaTilingData.mm1.n0 = gmMlaTilingData->mm1.n0;
    mlaTilingData.mm1.mLoop = gmMlaTilingData->mm1.mLoop;
    mlaTilingData.mm1.kLoop = gmMlaTilingData->mm1.kLoop;
    mlaTilingData.mm1.nLoop = gmMlaTilingData->mm1.nLoop;
    mlaTilingData.mm1.coreLoop = gmMlaTilingData->mm1.coreLoop;
    mlaTilingData.mm1.swizzleCount = gmMlaTilingData->mm1.swizzleCount;
    mlaTilingData.mm1.enShuffleK = gmMlaTilingData->mm1.enShuffleK;
    mlaTilingData.mm1.blockDim = gmMlaTilingData->mm1.blockDim;
    mlaTilingData.mm1.enLoadAllAmat = gmMlaTilingData->mm1.enLoadAllAmat;
    mlaTilingData.mm1.b0matPingPongBufferLen = gmMlaTilingData->mm1.b0matPingPongBufferLen;

    mlaTilingData.mm2.numBatch = gmMlaTilingData->mm2.numBatch;
    mlaTilingData.mm2.m = gmMlaTilingData->mm2.m;
    mlaTilingData.mm2.k = gmMlaTilingData->mm2.k;
    mlaTilingData.mm2.n = gmMlaTilingData->mm2.n;
    mlaTilingData.mm2.m0 = gmMlaTilingData->mm2.m0;
    mlaTilingData.mm2.k0 = gmMlaTilingData->mm2.k0;
    mlaTilingData.mm2.n0 = gmMlaTilingData->mm2.n0;
    mlaTilingData.mm2.mLoop = gmMlaTilingData->mm2.mLoop;
    mlaTilingData.mm2.kLoop = gmMlaTilingData->mm2.kLoop;
    mlaTilingData.mm2.nLoop = gmMlaTilingData->mm2.nLoop;
    mlaTilingData.mm2.coreLoop = gmMlaTilingData->mm2.coreLoop;
    mlaTilingData.mm2.swizzleCount = gmMlaTilingData->mm2.swizzleCount;
    mlaTilingData.mm2.enShuffleK = gmMlaTilingData->mm2.enShuffleK;
    mlaTilingData.mm2.blockDim = gmMlaTilingData->mm2.blockDim;
    mlaTilingData.mm2.enLoadAllAmat = gmMlaTilingData->mm2.enLoadAllAmat;
    mlaTilingData.mm2.b0matPingPongBufferLen = gmMlaTilingData->mm2.b0matPingPongBufferLen;

    mlaTilingData.mm3.numBatch = gmMlaTilingData->mm3.numBatch;
    mlaTilingData.mm3.m = gmMlaTilingData->mm3.m;
    mlaTilingData.mm3.k = gmMlaTilingData->mm3.k;
    mlaTilingData.mm3.n = gmMlaTilingData->mm3.n;
    mlaTilingData.mm3.m0 = gmMlaTilingData->mm3.m0;
    mlaTilingData.mm3.k0 = gmMlaTilingData->mm3.k0;
    mlaTilingData.mm3.n0 = gmMlaTilingData->mm3.n0;
    mlaTilingData.mm3.mLoop = gmMlaTilingData->mm3.mLoop;
    mlaTilingData.mm3.kLoop = gmMlaTilingData->mm3.kLoop;
    mlaTilingData.mm3.nLoop = gmMlaTilingData->mm3.nLoop;
    mlaTilingData.mm3.coreLoop = gmMlaTilingData->mm3.coreLoop;
    mlaTilingData.mm3.swizzleCount = gmMlaTilingData->mm3.swizzleCount;
    mlaTilingData.mm3.enShuffleK = gmMlaTilingData->mm3.enShuffleK;
    mlaTilingData.mm3.blockDim = gmMlaTilingData->mm3.blockDim;

    mlaTilingData.perTaskNum = gmMlaTilingData->perTaskNum;
    mlaTilingData.resTaskNum = gmMlaTilingData->resTaskNum;
    mlaTilingData.numCore = gmMlaTilingData->numCore;

    mlaTilingData.rmsNumCore1 = gmMlaTilingData->rmsNumCore1;
    mlaTilingData.rmsNumCol1 = gmMlaTilingData->rmsNumCol1;
    mlaTilingData.rmsNumCore2 = gmMlaTilingData->rmsNumCore2;
    mlaTilingData.rmsNumCol2 = gmMlaTilingData->rmsNumCol2;

    mlaTilingData.hiddenSizeQ = gmMlaTilingData->hiddenSizeQ;
    mlaTilingData.headNumQ = gmMlaTilingData->headNumQ;
    mlaTilingData.headDim = gmMlaTilingData->headDim;
    mlaTilingData.concatSize = gmMlaTilingData->concatSize;
    mlaTilingData.rotaryCoeff = gmMlaTilingData->rotaryCoeff;
    mlaTilingData.ntokens = gmMlaTilingData->ntokens;
    mlaTilingData.realCore = gmMlaTilingData->realCore;
    mlaTilingData.nlCoreRun = gmMlaTilingData->nlCoreRun;
    mlaTilingData.lCoreRun = gmMlaTilingData->lCoreRun;
    mlaTilingData.maxNPerLoopForUb = gmMlaTilingData->maxNPerLoopForUb;
    mlaTilingData.preCoreLoopTime = gmMlaTilingData->preCoreLoopTime;
    mlaTilingData.preCoreLoopNLast = gmMlaTilingData->preCoreLoopNLast;
    mlaTilingData.lastCoreLoopTime = gmMlaTilingData->lastCoreLoopTime;
    mlaTilingData.lastCoreLoopNLast = gmMlaTilingData->lastCoreLoopNLast;

    mlaTilingData.esqFrontCore = gmMlaTilingData->esqFrontCore;
    mlaTilingData.esqTailCore = gmMlaTilingData->esqTailCore;
    mlaTilingData.esqFrontCoreBatch = gmMlaTilingData->esqFrontCoreBatch;
    mlaTilingData.esqTailCoreBatch = gmMlaTilingData->esqTailCoreBatch;
    mlaTilingData.esqHeadNum = gmMlaTilingData->esqHeadNum;
    mlaTilingData.esqColNum = gmMlaTilingData->esqColNum;
    mlaTilingData.esqUbHeadLoop = gmMlaTilingData->esqUbHeadLoop;
    mlaTilingData.esqHeadPerLoop = gmMlaTilingData->esqHeadPerLoop;
    mlaTilingData.esqHeadTail = gmMlaTilingData->esqHeadTail;
    mlaTilingData.esqColLoop = gmMlaTilingData->esqColLoop;
    mlaTilingData.esqColTail = gmMlaTilingData->esqColTail;

    // InDtype[1] cacheMode[2] weightFormat1[1] weightFormat2[1] weightFormat3[1] quantMode[2]
    if (TILING_KEY_IS(1)) { // fp16_cm0_nd_nd_nd_qm1 = 0b00000001
        MLAOperation<half, 0, DataFormat::ND, DataFormat::ND, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(5)) { // fp16_cm0_nd_nd_nz_qm1 = 0b00000101
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(9)) { // fp16_cm0_nd_nz_nd_qm1 = 0b00001001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(13)) { // fp16_cm0_nd_nz_nz_qm1 = 0b00001101
        MLAOperation<half, 0, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(17)) { // fp16_cm0_nz_nd_nd_qm1 = 0b00010001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(21)) { // fp16_cm0_nz_nd_nz_qm1 = 0b00010101
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(25)) { // fp16_cm0_nz_nz_nd_qm1 = 0b00011001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(29)) { // fp16_cm0_nz_nz_nz_qm1 = 0b00011101
        MLAOperation<half, 0, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(33)) { // fp16_cm1_nd_nd_nd_qm1 = 0b00100001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(37)) { // fp16_cm1_nd_nd_nz_qm1 = 0b00100101
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(41)) { // fp16_cm1_nd_nz_nd_qm1 = 0b00101001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(45)) { // fp16_cm1_nd_nz_nz_qm1 = 0b00101101
        MLAOperation<half, 1, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(49)) { // fp16_cm1_nz_nd_nd_qm1 = 0b00110001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(53)) { // fp16_cm1_nz_nd_nz_qm1 = 0b00110101
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(57)) { // fp16_cm1_nz_nz_nd_qm1 = 0b00111001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(61)) { // fp16_cm1_nz_nz_nz_qm1 = 0b00111101
        MLAOperation<half, 1, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(65)) { // fp16_cm2_nd_nd_nd_qm1 = 0b01000001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(69)) { // fp16_cm2_nd_nd_nz_qm1 = 0b01000101
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(73)) { // fp16_cm2_nd_nz_nd_qm1 = 0b01001001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(77)) { // fp16_cm2_nd_nz_nz_qm1 = 0b01001101
        MLAOperation<half, 2, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(81)) { // fp16_cm2_nz_nd_nd_qm1 = 0b01010001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(85)) { // fp16_cm2_nz_nd_nz_qm1 = 0b01010101
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(89)) { // fp16_cm2_nz_nz_nd_qm1 = 0b01011001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(93)) { // fp16_cm2_nz_nz_nz_qm1 = 0b01011101
        MLAOperation<half, 2, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(97)) { // fp16_cm3_nd_nd_nd_qm1 = 0b01100001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(101)) { // fp16_cm3_nd_nd_nz_qm1 = 0b01100101
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(105)) { // fp16_cm3_nd_nz_nd_qm1 = 0b01101001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(109)) { // fp16_cm3_nd_nz_nz_qm1 = 0b01101101
        MLAOperation<half, 3, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(113)) { // fp16_cm3_nz_nd_nd_qm1 = 0b01110001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(117)) { // fp16_cm3_nz_nd_nz_qm1 = 0b01110101
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(121)) { // fp16_cm3_nz_nz_nd_qm1 = 0b01111001
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(125)) { // fp16_cm3_nz_nz_nz_qm1 = 0b01111101
        MLAOperation<half, 3, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(128)) { // bf16_cm0_nd_nd_nd_qm0 = 0b10000000
        MLAOperation<__bf16, 0, DataFormat::ND, DataFormat::ND, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(129)) { // bf16_cm0_nd_nd_nd_qm1 = 0b10000001
        MLAOperation<__bf16, 0, DataFormat::ND, DataFormat::ND, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(132)) { // bf16_cm0_nd_nd_nz_qm0 = 0b10000100
        MLAOperation<__bf16, 0, DataFormat::ND, DataFormat::ND, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(133)) { // bf16_cm0_nd_nd_nz_qm1 = 0b10000101
        MLAOperation<__bf16, 0, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(136)) { // bf16_cm0_nd_nz_nd_qm0 = 0b10001000
        MLAOperation<__bf16, 0, DataFormat::ND, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(137)) { // bf16_cm0_nd_nz_nd_qm1 = 0b10001001
        MLAOperation<__bf16, 0, DataFormat::ND, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(140)) { // bf16_cm0_nd_nz_nz_qm0 = 0b10001100
        MLAOperation<__bf16, 0, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(141)) { // bf16_cm0_nd_nz_nz_qm1 = 0b10001101
        MLAOperation<__bf16, 0, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(144)) { // bf16_cm0_nz_nd_nd_qm0 = 0b10010000
        MLAOperation<__bf16, 0, DataFormat::NZ, DataFormat::ND, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(145)) { // bf16_cm0_nz_nd_nd_qm1 = 0b10010001
        MLAOperation<__bf16, 0, DataFormat::NZ, DataFormat::ND, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(148)) { // bf16_cm0_nz_nd_nz_qm0 = 0b10010100
        MLAOperation<__bf16, 0, DataFormat::NZ, DataFormat::ND, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(149)) { // bf16_cm0_nz_nd_nz_qm1 = 0b10010101
        MLAOperation<__bf16, 0, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(152)) { // bf16_cm0_nz_nz_nd_qm0 = 0b10011000
        MLAOperation<__bf16, 0, DataFormat::NZ, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(153)) { // bf16_cm0_nz_nz_nd_qm1 = 0b10011001
        MLAOperation<__bf16, 0, DataFormat::NZ, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(156)) { // bf16_cm0_nz_nz_nz_qm0 = 0b10011100
        MLAOperation<__bf16, 0, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(157)) { // bf16_cm0_nz_nz_nz_qm1 = 0b10011101
        MLAOperation<__bf16, 0, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(160)) { // bf16_cm1_nd_nd_nd_qm0 = 0b10100000
        MLAOperation<__bf16, 1, DataFormat::ND, DataFormat::ND, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(161)) { // bf16_cm1_nd_nd_nd_qm1 = 0b10100001
        MLAOperation<__bf16, 1, DataFormat::ND, DataFormat::ND, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(164)) { // bf16_cm1_nd_nd_nz_qm0 = 0b10100100
        MLAOperation<__bf16, 1, DataFormat::ND, DataFormat::ND, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(165)) { // bf16_cm1_nd_nd_nz_qm1 = 0b10100101
        MLAOperation<__bf16, 1, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(168)) { // bf16_cm1_nd_nz_nd_qm0 = 0b10101000
        MLAOperation<__bf16, 1, DataFormat::ND, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(169)) { // bf16_cm1_nd_nz_nd_qm1 = 0b10101001
        MLAOperation<__bf16, 1, DataFormat::ND, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(172)) { // bf16_cm1_nd_nz_nz_qm0 = 0b10101100
        MLAOperation<__bf16, 1, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(173)) { // bf16_cm1_nd_nz_nz_qm1 = 0b10101101
        MLAOperation<__bf16, 1, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(176)) { // bf16_cm1_nz_nd_nd_qm0 = 0b10110000
        MLAOperation<__bf16, 1, DataFormat::NZ, DataFormat::ND, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(177)) { // bf16_cm1_nz_nd_nd_qm1 = 0b10110001
        MLAOperation<__bf16, 1, DataFormat::NZ, DataFormat::ND, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(180)) { // bf16_cm1_nz_nd_nz_qm0 = 0b10110100
        MLAOperation<__bf16, 1, DataFormat::NZ, DataFormat::ND, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(181)) { // bf16_cm1_nz_nd_nz_qm1 = 0b10110101
        MLAOperation<__bf16, 1, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(184)) { // bf16_cm1_nz_nz_nd_qm0 = 0b10111000
        MLAOperation<__bf16, 1, DataFormat::NZ, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(185)) { // bf16_cm1_nz_nz_nd_qm1 = 0b10111001
        MLAOperation<__bf16, 1, DataFormat::NZ, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(188)) { // bf16_cm1_nz_nz_nz_qm0 = 0b10111100
        MLAOperation<__bf16, 1, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(189)) { // bf16_cm1_nz_nz_nz_qm1 = 0b10111101
        MLAOperation<__bf16, 1, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(192)) { // bf16_cm2_nd_nd_nd_qm0 = 0b11000000
        MLAOperation<__bf16, 2, DataFormat::ND, DataFormat::ND, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(193)) { // bf16_cm2_nd_nd_nd_qm1 = 0b11000001
        MLAOperation<__bf16, 2, DataFormat::ND, DataFormat::ND, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(196)) { // bf16_cm2_nd_nd_nz_qm0 = 0b11000100
        MLAOperation<__bf16, 2, DataFormat::ND, DataFormat::ND, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(197)) { // bf16_cm2_nd_nd_nz_qm1 = 0b11000101
        MLAOperation<__bf16, 2, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(200)) { // bf16_cm2_nd_nz_nd_qm0 = 0b11001000
        MLAOperation<__bf16, 2, DataFormat::ND, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(201)) { // bf16_cm2_nd_nz_nd_qm1 = 0b11001001
        MLAOperation<__bf16, 2, DataFormat::ND, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(204)) { // bf16_cm2_nd_nz_nz_qm0 = 0b11001100
        MLAOperation<__bf16, 2, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(205)) { // bf16_cm2_nd_nz_nz_qm1 = 0b11001101
        MLAOperation<__bf16, 2, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(208)) { // bf16_cm2_nz_nd_nd_qm0 = 0b11010000
        MLAOperation<__bf16, 2, DataFormat::NZ, DataFormat::ND, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(209)) { // bf16_cm2_nz_nd_nd_qm1 = 0b11010001
        MLAOperation<__bf16, 2, DataFormat::NZ, DataFormat::ND, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(212)) { // bf16_cm2_nz_nd_nz_qm0 = 0b11010100
        MLAOperation<__bf16, 2, DataFormat::NZ, DataFormat::ND, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(213)) { // bf16_cm2_nz_nd_nz_qm1 = 0b11010101
        MLAOperation<__bf16, 2, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(216)) { // bf16_cm2_nz_nz_nd_qm0 = 0b11011000
        MLAOperation<__bf16, 2, DataFormat::NZ, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(217)) { // bf16_cm2_nz_nz_nd_qm1 = 0b11011001
        MLAOperation<__bf16, 2, DataFormat::NZ, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(220)) { // bf16_cm2_nz_nz_nz_qm0 = 0b11011100
        MLAOperation<__bf16, 2, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(221)) { // bf16_cm2_nz_nz_nz_qm1 = 0b11011101
        MLAOperation<__bf16, 2, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(224)) { // bf16_cm3_nd_nd_nd_qm0 = 0b11100000
        MLAOperation<__bf16, 3, DataFormat::ND, DataFormat::ND, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(225)) { // bf16_cm3_nd_nd_nd_qm1 = 0b11100001
        MLAOperation<__bf16, 3, DataFormat::ND, DataFormat::ND, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(228)) { // bf16_cm3_nd_nd_nz_qm0 = 0b11100100
        MLAOperation<__bf16, 3, DataFormat::ND, DataFormat::ND, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(229)) { // bf16_cm3_nd_nd_nz_qm1 = 0b11100101
        MLAOperation<__bf16, 3, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(232)) { // bf16_cm3_nd_nz_nd_qm0 = 0b11101000
        MLAOperation<__bf16, 3, DataFormat::ND, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(233)) { // bf16_cm3_nd_nz_nd_qm1 = 0b11101001
        MLAOperation<__bf16, 3, DataFormat::ND, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(236)) { // bf16_cm3_nd_nz_nz_qm0 = 0b11101100
        MLAOperation<__bf16, 3, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(237)) { // bf16_cm3_nd_nz_nz_qm1 = 0b11101101
        MLAOperation<__bf16, 3, DataFormat::ND, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(240)) { // bf16_cm3_nz_nd_nd_qm0 = 0b11110000
        MLAOperation<__bf16, 3, DataFormat::NZ, DataFormat::ND, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(241)) { // bf16_cm3_nz_nd_nd_qm1 = 0b11110001
        MLAOperation<__bf16, 3, DataFormat::NZ, DataFormat::ND, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(244)) { // bf16_cm3_nz_nd_nz_qm0 = 0b11110100
        MLAOperation<__bf16, 3, DataFormat::NZ, DataFormat::ND, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(245)) { // bf16_cm3_nz_nd_nz_qm1 = 0b11110101
        MLAOperation<__bf16, 3, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(248)) { // bf16_cm3_nz_nz_nd_qm0 = 0b11111000
        MLAOperation<__bf16, 3, DataFormat::NZ, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(249)) { // bf16_cm3_nz_nz_nd_qm1 = 0b11111001
        MLAOperation<__bf16, 3, DataFormat::NZ, DataFormat::NZ, DataFormat::ND, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(252)) { // bf16_cm3_nz_nz_nz_qm0 = 0b11111100
        MLAOperation<__bf16, 3, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TENSOR_ASYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
                wuqGm, bias2Gm, wukGm, descale1Gm, descale2Gm, gmCtkvScale, gmQnopeScale, qGm, keycacheOutGm, qGm2,
        ...
        op.ProcessCube();
        op.ProcessVector();
    } else if (TILING_KEY_IS(253)) { // bf16_cm3_nz_nz_nz_qm1 = 0b11111101
        MLAOperation<__bf16, 3, DataFormat::NZ, DataFormat::NZ, DataFormat::NZ, QuantMode::PER_TOKEN_SYMM_QUANT> op(
            mlaTilingData, tilingGm);
        op.Init(hiddenStateGm, gamma1Gm, beta1Gm, quantScale1Gm, quantOffset1Gm, wdqkvGm, bias1Gm, gamma2Gm, beta2Gm,
                quantScale2Gm, quantOffset2Gm, gamma3Gm, sin1Gm, cos1Gm, sin2Gm, cos2Gm, keycacheGm, slotMappingGm,
