...
#ifndef CATLASS_CONV_HELPER_HPP
#define CATLASS_CONV_HELPER_HPP

#include "catlass/catlass.hpp"
#include "catlass/layout/layout.hpp"
#include "catlass/conv/conv_type.hpp"

namespace Catlass::Conv::helper {
...
template<class Element>
struct L1ATypeSelector<Conv::Conv2dType<Element, layout::Fmap>> {
    using L1AType = Conv::Conv2dType<Element, layout::Fmap, AscendC::TPosition::A1>;
};
...
template<class Element>
struct L1BTypeSelector<Conv::Conv2dType<Element, layout::Filter>> {
    using L1BType = Conv::Conv2dType<Element, layout::Filter, AscendC::TPosition::A1>;
};

///////////////////////////////////////
} // namespace Catlass::Conv::helper

#endif // CATLASS_CONV_HELPER_HPP
