...
public:
    ...
    void operator()(
        ...
        AscendC::GlobalTensor<T> gamma3GmTensor, AscendC::GlobalTensor<int32_t> slotMappingGmTensor, AscendC::GlobalTensor<int32_t> descale1gmTensor,
        ...
        AscendC::GlobalTensor<float> s5GmTensor, AscendC::GlobalTensor<T> cos1GmTensor, AscendC::GlobalTensor<K_NOPE_DTYPE> keycacheGmTensor1,
