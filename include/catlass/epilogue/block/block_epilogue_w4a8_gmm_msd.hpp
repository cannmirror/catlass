...
public:
    ...
    )
    {
        ...
        for (uint32_t loopIdx = subblockIdx; loopIdx < tileLoops; loopIdx += subblockNum) {
            ...
            auto gmOffsetLow = MatrixCoord{1L, 0L};
            ...
            AscendC::Cast(ubCFp32, ubC, AscendC::RoundMode::CAST_NONE, calcNum * 2);
            ...
            tileRowBroadcastAdd(ubAddBiasRes, ubInnerAddRes, ubBias, calcTileShape);
            AscendC::PipeBarrier<PIPE_V>();
