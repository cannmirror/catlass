#ifndef CATLASS_GEMM_KERNEL_MATMUL_PRELOAD_VISITOR_HPP
#define CATLASS_GEMM_KERNEL_MATMUL_PRELOAD_VISITOR_HPP
...
public:
    ...
    struct AicFinishSync {
        using MatmulKernel = MatmulPreloadVisitor<BlockMmad, BlockEpilogue, BlockScheduler>;
...
#endif // CATLASS_GEMM_KERNEL_MATMUL_PRELOAD_VISITOR_HPP
