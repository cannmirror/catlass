...
#ifndef CATLASS_GEMM_KERNEL_W4A8_PERTOKEN_GROUPED_MATMUL_MSD_HPP
#define CATLASS_GEMM_KERNEL_W4A8_PERTOKEN_GROUPED_MATMUL_MSD_HPP
...
public:
    ...
    struct Params {
        ...
        CATLASS_HOST_DEVICE
        Params(
            GemmCoord problemShape_, uint32_t kGroupSize_,
    ...
    {
        Params params{args.problemShape, args.kGroupSize,
            args.quantGroupNum,
...
private:
    ...
    struct AicWaitFunc {
        using MatmulKernel = W4A8MatmulMSD<BlockMmad, BlockEpilogue, BlockScheduler,
...
#endif // CATLASS_GEMM_KERNEL_W4A8_PERTOKEN_GROUPED_MATMUL_MSD_HPP