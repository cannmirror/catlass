...
#ifndef CATLASS_GEMM_KERNEL_W4A8_GROUPED_MATMUL_MSD_HPP
#define CATLASS_GEMM_KERNEL_W4A8_GROUPED_MATMUL_MSD_HPP
...
public:
    ...
    struct Params {
        ...
        CATLASS_HOST_DEVICE
        Params(
            GemmCoord problemShape_, uint32_t problemCount_, uint32_t kGroupSize_,
            uint32_t quantGroupNum_, GM_ADDR ptrGroupList_,
            GM_ADDR ptrA_, LayoutA layoutA_,
            GM_ADDR ptrB_, LayoutB layoutB_,
            GM_ADDR ptrScale_, LayoutScale layoutScale_,
            GM_ADDR ptrBias_, LayoutScale layoutBias_,
            ...
            kGroupSize(kGroupSize_), quantGroupNum(quantGroupNum_),
    ...
    static size_t GetWorkspaceSize(const Arguments &args)
    {
        ...
        size_t sizeWorkspace = lenWorkspace * sizeof(half);
        return sizeWorkspace;
    }

    static Params ToUnderlyingArguments(const Arguments &args, uint8_t *workspace)
    {
        Params params{args.problemShape, args.problemCount, args.kGroupSize,
            args.quantGroupNum, args.ptrGroupList,
            args.ptrA, args.layoutA,
            args.ptrB, args.layoutB,
            args.ptrScale, args.layoutScale,
            args.ptrBias, args.layoutBias,
    ...
    void operator()<AscendC::AIC>(Params const &params)
    {
        ...
        auto quantGroupNum = params.quantGroupNum;
        ...
        for (uint32_t groupIdx = 0; groupIdx < params.problemCount; ++groupIdx) {
            ...
            for (uint32_t loopIdx = startLoopIdx; loopIdx < coreLoops; loopIdx += coreNum) {
                ...
                MatrixCoord offsetScale{0, blockCoord.n() * L1TileShape::N};
    ...
    void operator()<AscendC::AIV>(Params const &params)
    {
        ...
        for (uint32_t groupIdx = 0; groupIdx < params.problemCount; ++groupIdx) {
            ...
            EpilogueParams epilogueParams{
                params.ptrBias + gmGroupOffsetBias, layoutBias,
            ...
            gmGroupOffsetPerTokenScale += oriInGroupProblemShape.m();
            gmGroupOffsetD += oriInGroupProblemShape.m() * inGroupProblemShape.n();
...
private:
    ...
    struct AicWaitFunc {
        using MatmulKernel = W4A8GroupedMatmulMSD<BlockMmad, BlockEpilogue, BlockScheduler,
            WORKSPACE_STAGES, ElementGroupList, ElementScale, LayoutScale>;
...
#endif // CATLASS_GEMM_KERNEL_W4A8_GROUPED_MATMUL_MSD_HPP