...
public:
    ...
    static constexpr uint32_t L1A_SIZE = ArchTag::L1_SIZE / 2;
    ...
    BlockMmad(Arch::Resource<ArchTag> &resource, uint32_t l1BufAddrStart = 0)
    {
        ...
        uint32_t l1BOffset = l1BufAddrStart + L1A_SIZE;
        // Init L1A related
        ...
        GemmCoord const &actualShape, bool needLoadL1)
    {
        ...
        auto layoutAInL1 = LayoutAInL1::template MakeLayout<ElementA>(L1TileShape::M, actualShape.k());
        ...
        if (needLoadL1) {
            ...
            copyGmToL1A(l1ATensorList[0], gmA, layoutAInL1, layoutTileA);
