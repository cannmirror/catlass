...
#ifndef CATLASS_GEMM_BLOCK_BLOCK_MMAD_DYNAMIC_SINGLE_CORE_SPLITK_HPP
#define CATLASS_GEMM_BLOCK_BLOCK_MMAD_DYNAMIC_SINGLE_CORE_SPLITK_HPP
...
template <uint32_t L1A_STAGES_, uint32_t L1B_STAGES_, uint32_t L0C_STAGES_, bool ENABLE_UNIT_FLAG_, 
    class L1TileShape_, class L0TileShape_, class AType_, class BType_, class CType_,
...
public:
    ...
    BlockMmad(GemmCoord const &l1TileShape_, GemmCoord const &l0TileShape_, Arch::Resource<ArchTag> &resource, 
        uint32_t l1BufAddrStart = 0) : l1TileShape(l1TileShape_), l0TileShape(l0TileShape_)
    {
...
#endif  // CATLASS_GEMM_BLOCK_BLOCK_MMAD_DYNAMIC_SINGLE_CORE_SPLITK_HPP
