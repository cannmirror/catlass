...
/// Partial specialization for CopyL1ToL0B, AtlasA5, zN in and nZ out.
...
struct TileCopyTla<
    ...
    std::enable_if_t<tla::detail::iszN<ElementSrc, LayoutSrc>::value && tla::detail::isnZ<ElementDst, LayoutDst>::value>> {
