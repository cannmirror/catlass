...
static void Run(const Options &options) {
    ...
    using EVG = Epilogue::Fusion::TreeVisitor<
        ...
        Epilogue::Fusion::TreeVisitor<
            Epilogue::Fusion::VisitorCompute<Epilogue::Fusion::Silu, half>,
    ...
    // golden::ComputeMatmulElemWiseAdd(options.problemShape, hostA, layoutA, hostB, layoutB, hostGolden, layoutD);
