...
#include "catlass/gemm/kernel/w4a8_matmul_msd.hpp"
...
void Run(Options const &options)
{
    ...
    size_t lenScale = static_cast<size_t>(n) * quantGroupNum;
    ...
    uint8_t *deviceA, *deviceB, *deviceScale, *deviceBias, *devicePerTokenScale;
    uint8_t *deviceD;
    ...
    // kernel level
    using MatmulKernel = Gemm::Kernel::W4A8MatmulMSD<BlockMmad, BlockEpilogue,
