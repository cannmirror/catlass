...
## 代码组织
```
├── 37_a5_tail_multi_core_splitk_matmul
...
```sh
# 编译指定用例
bash scripts/build.sh 37_a5_tail_multi_core_splitk_matmul -DCATLASS_BISHENG_ARCH=a5
cd output/bin
# 可执行文件名 |矩阵m轴|n轴|k轴|Device ID
# Device ID可选，默认为0
./37_a5_tail_multi_core_splitk_matmul 256 512 1024 0
```
执行结果如下，说明精度比对成功。
```
Compare success.
