...
class PaddingHybridSplitkMatmulTemplate:

    TEMPLATE = """
#include "kernel/padding_hybrid_splitk_matmul_kernel.h"
...
{{
    ...
    LaunchPaddingHybridSplitkMatmulKernel<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC,
...
{{
    ...
    constexpr PaddingTag paddingTagB = {padding_tag_b};
    constexpr PaddingTag paddingTagC = {padding_tag_c};
    return PaddingHybridSplitkMatmulKernelGetWorkspaceSize<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC,
...
"""
    ...
    def gen_code(kernel_name, base_file_name, kernel_serial, dtype, kernel_info):
        ...
        for l_tag_a, l_tag_b, p_tag_a, p_tag_b, p_tag_c in combinations:
            # kernel_fun_name can be PaddingHybridSplitkMatmulKernelHalfLayout00
            kernel_func_name = (
                kernel_name
                + dtype.capitalize()
                + "Layout"
            ...
            # launch_kernel_fun_name can be LaunchPaddingHybridSplitkMatmulKernelHalfLayout00
            launch_kernel_func_name = "Launch" + kernel_func_name
            # get_workspace_fun_name can be PaddingHybridSplitkMatmulKernelHalfLayout00GetWorkspaceSize
            ...
            content = PaddingHybridSplitkMatmulTemplate.TEMPLATE.format(
