...
bash ../../scripts/build.sh --clean --simulator 35_row_broadcast_reduction_evt
if [ $? -eq 0 ]; then
    # export ASCEND_SLOG_PRINT_TO_STDOUT=1
    LD_LIBRARY_PATH=/home/workspace/wyf/cann/ascend-toolkit/latest/tools/simulator/Ascend910B3/lib:$LD_LIBRARY_PATH
    msprof op simulator ../../output/bin/35_row_broadcast_reduction_evt 256 512 1024 0
    # ./35_row_broadcast_reduction_evt 256 512 1024 0
    # 随机生成一些用例
