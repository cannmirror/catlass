...
struct Options {
  const std::string HELPER = 
    "99_basic_conv2d batch, hi, wi, cin, cout, kh, kw, padLeft, padRight, padTop, padBottom, strideH, strideW, dilationH, dilationW [device_id]";
...
void Run(Options const &options) {
  ...
  using DispatchPolicy = Conv::ConvAtlasA2Pingpong<
      L1A_STAGES, L1B_STAGES, L0A_STAGES, L0B_STAGES, L0C_STAGES, ENABLE_UNIT_FLAG>;
