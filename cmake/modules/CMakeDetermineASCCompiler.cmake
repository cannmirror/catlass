...
set(CMAKE_ASC_COMPILER_ENV_VAR "Ascend")
message(STATUS "CMAKE_CURRENT_LIST_DIR: " ${CMAKE_CURRENT_LIST_DIR})

set(CMAKE_ASC_HOST_IMPLICIT_LINK_DIRECTORIES
    ${CMAKE_ASC_HOME_PATH}/lib64
)
...
if(DEFINED ASCEND_ENABLE_SIMULATOR AND ASCEND_ENABLE_SIMULATOR)
    ...
    list(APPEND CMAKE_ASC_HOST_IMPLICIT_LINK_DIRECTORIES
        ${CMAKE_ASC_HOME_PATH}/tools/simulator/${SIMULATOR_NPU_MODEL}/lib
        ${CMAKE_ASC_HOME_PATH}/acllib/lib64/stub)
...
set(CMAKE_ASC_HOST_IMPLICIT_INCLUDE_DIRECTORIES
    ${CMAKE_ASC_HOME_PATH}/include
    ${CMAKE_ASC_HOME_PATH}/include/experiment/runtime
    ${CMAKE_ASC_HOME_PATH}/include/experiment/msprof
)

if(NOT DEFINED ASCEND_ENABLE_ASCENDC OR ASCEND_ENABLE_ASCENDC)
    list(APPEND CMAKE_ASC_HOST_IMPLICIT_INCLUDE_DIRECTORIES
        ${CMAKE_ASC_HOME_PATH}/compiler/tikcpp
        ${CMAKE_ASC_HOME_PATH}/compiler/tikcpp/tikcfw
        ${CMAKE_ASC_HOME_PATH}/compiler/tikcpp/tikcfw/impl
        ${CMAKE_ASC_HOME_PATH}/compiler/tikcpp/tikcfw/interface
    )
endif()
